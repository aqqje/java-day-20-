...
public class TestBanking5_2 {
  ...
  public static void main(String[] args) {
    ...
    customer.setSavingAcoount(new SavingAccount(500.00, 0.05));
    customer.setCheckingAccount(new CheckingAccount(200.00, customer.getSavingAcoount()));
    ...
    System.out.println("Customer [" + customer.getLastName()
		       ...
		       + customer.getSavingAcoount().getBalance());
